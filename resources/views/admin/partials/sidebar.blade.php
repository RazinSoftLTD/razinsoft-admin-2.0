@php
    ...
    // Collapsible groups. 'staff' groups show for staff too; others are admin-only.
    $groups = collect([
        [
            'label' => 'CRM',
            'staff' => true,
            ...
            'items' => [
                ['label' => 'Leads', 'route' => 'admin.leads.index', 'active' => ['admin.leads.index', 'admin.leads.show', 'admin.leads.edit', 'admin.leads.create', 'admin.leads.import.form'], 'icon' => 'M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8ZM19 8v6M22 11h-6'],
                ['label' => 'Follow-up', 'route' => 'admin.leads.follow-up', 'active' => 'admin.leads.follow-up', 'icon' => 'M12 8v4l3 2 M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z'],
                ['label' => 'Deals', 'route' => 'admin.deals.index', 'active' => 'admin.deals.*', 'icon' => 'M3 3v18h18 M7 14l4-4 3 3 5-6'],
            ],
        ],
        [
            'label' => 'Invoices',
    ...
    ])->filter(fn ($g) => $isAdmin || ! empty($g['staff']))->all();
@endphp
