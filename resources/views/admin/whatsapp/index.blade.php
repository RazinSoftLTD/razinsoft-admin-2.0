...
@section('content')
    ...
    <div x-data="waInbox()" x-init="init(); forceCollapse = true; lockScroll = true" style="height:calc(100dvh - 4rem)" class="-m-4 flex overflow-hidden border-t border-gray-100 bg-white sm:-m-6">
        {{-- ============ LEFT: chat list ============ --}}
