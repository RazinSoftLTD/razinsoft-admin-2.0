...
class InvoiceLogoTest extends TestCase {
    ...
    public function test_pdf_embeds_logo_image(): void {
        ...
        $inv = ClientInvoice::create(['invoice_number'=>'INV-LOGO-1','public_token'=>Str::random(40),'bill_to_name'=>'X','invoice_date'=>date('Y-m-d'),'currency'=>'USD','status'=>'sent','subtotal'=>100,'total'=>100,'created_by'=>$admin->id]);
