...
class LeadSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $rows = [
            ...
            ['Square Toiletries Ltd.', 'Mizanur Rahman', 'Purchase Head', 'mizan.rahman@squaretoiletries.com', '+880 1687-112233', 'Referral', 'proposal', 'high', $arafat, 'Retail'],
            ['Akij Group', 'Tanjina Akter', 'Asst. Manager', 'tanjina.akter@akijgroup.com', '+880 1722-334455', 'Advertisement', 'negotiation', 'medium', $fahim, 'Logistics'],
